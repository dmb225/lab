...
|----------|---------|-------------|
| `PROJECT_NAME` | `lab` | Display name for the project |
...
| `LOGFIRE_SERVICE_NAME` | `lab` | Service name in Logfire dashboard |
